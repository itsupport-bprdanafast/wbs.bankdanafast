        ...
        <div class="bg-white rounded-lg shadow-lg p-6 md:p-8">
            ...
            <form wire:submit="submit" class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <x-input wire:model="reporter_phone" type="tel" label="No. Telepon" placeholder="08xxxxxxxxxx" />
                </div>
                <div class="space-y-4">
                    <x-date label="Tanggal Kejadian *" format="DD MMMM YYYY" :max-date="now()" wire:model="date_incidents" />
